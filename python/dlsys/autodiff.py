...
class AddByConstOp(Op):
    ...
    def compiled_func(self, node, input_shapes, tgt, tgt_host):
        ...
        return tvm_op.make_elemwise_add_by_const(
            input_shapes[0], tgt, tgt_host, "elem_add_const"
        )
...
class MatMulOp(Op):
    ...
    def compiled_func(self, node, input_shapes, tgt, tgt_host):
        """TODO: Your code here"""
        return tvm_op.make_matrix_mul(input_shapes[0], node.matmul_attr_trans_A, input_shapes[1],
                                      node.matmul_attr_trans_B, tgt, tgt_host=tgt_host, func_name="matmul")
...
class BroadcastToOp(Op):
    ...
    def compiled_func(self, node, input_shapes, tgt, tgt_host):
        """TODO: Your code here"""
        return tvm_op.make_broadcast_to(input_shapes[0], input_shapes[1], tgt, tgt_host, func_name="broadcast_to")
...
class SoftmaxCrossEntropyOp(Op):
    ...
    def compiled_func(self, node, input_shapes, tgt, tgt_host):
        """TODO: Your code here"""
        return tvm_op.make_matrix_softmax_cross_entropy(input_shapes[0], tgt, tgt_host, func_name="softmax_cross_entropy")
...
class SoftmaxOp(Op):
    ...
    def compiled_func(self, node, input_shapes, tgt, tgt_host):
        """TODO: Your code here"""
        return tvm_op.make_matrix_softmax(input_shapes[0], tgt, tgt_host, func_name="cross_entropy")
...
class ReluGradientOp(Op):
    ...
    def compiled_func(self, node, input_shapes, tgt, tgt_host):
        """TODO: Your code here"""
        return tvm_op.make_relu_gradient(input_shapes[0], tgt, tgt_host, func_name="relu_gradient")
...
class Executor(object):
    ...
    def run(self, feed_dict, convert_to_numpy_ret_vals=False):
        ...
        # e.g. call run() on test data after training
